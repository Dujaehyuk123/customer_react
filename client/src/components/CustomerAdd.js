    ...
    render() {
        return (
            <form onSubmit={this.handleFormSubmit}>
                <h1>ADD CUSTOMER</h1>
                PROFILE IMAGE: <input type="file" name="file" file={this.state.file} value={this.state.fileName} onChange={this.state.handleFileChange}/><br/>
                ...
                job:  <input type="job" name="job" value={this.state.job} onChange={this.handleValueChange}/><br/>   
